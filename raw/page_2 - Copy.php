...
$where = (!empty($planId)) ? "id = $planId" : "title = '$title'";
               ...
               <div class="owl-carousel owl-theme">
                  ...
                  <?php for ($i = 1; $i <= 6; $i++):
                     if (!empty($row["ame{$i}"]))
                     {
                        ?>
                        <div class="item">
                           <img src="dcity/public/assets/img/<?php echo $row["ame{$i}"]; ?>" alt="" class="img-fluid">
                  ...
                  if (!empty($floor_plan))
                  {
                     foreach ($floor_plan as $k => $v)
                     {
                        ...
                        <tr class="align-baseline">
                           ...
                           <td><?php echo (!empty($v['ask_for_price'])) ? 'Ask For Price' : number_format($v['starting_price']) . ' AED'; ?>
                           </td>
                        </tr>
                        <?php
                     }
